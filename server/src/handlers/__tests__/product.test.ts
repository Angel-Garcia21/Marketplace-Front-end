...
describe('GET /api/products/', () => {
    ...
    it('GET A JSON response whith products', async () => {
        const response = await request(server).get('/api/products')
...
describe(`GET /api/products/:id`, () => {
    ...
    it('get a JSON response for a single poroduct', async () => {
...
describe('PUT /api/product/:id ', () => {
    ...
    it('should return a 404 repsonse for a non-existen product', async () => {
        const productId = 2000
        const response = await request(server).
...
describe('PATCH /api/products/:id', () => {
    ...
    it('should update the product avilability', async () => {
